...
export default function Detail({Data, DonationsData}) {
  ...
  return (
    ...
    <DetailWrapper className="flex flex-col bg-light-green w-[1140px] h-auto p-8">
    ...
    <div className="flex justify-between">
      ...
      <RightContainer className="mt-4 ml-16 ">
        ...
        <DonateSection className="mt-4 flex justify-normal space-x-6 items-center mt-[3%]">
          <Input className=" p-[15px] font-iowan border border-2 bg-[#FFFFFF] w-[381px] text-black border-[#000000] rounded" value={amount} onChange={(e) => setAmount(e.target.value)} type="number" placeholder="Enter Amount To Donate" />
